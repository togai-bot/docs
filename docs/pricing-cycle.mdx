...
* **Deferred revenue computation** - This configuration allows you the flexibility to change your price plan during an Ongoing billing cycle and apply changes at any time from the start of the ongoing cycle. Ongoing billing cycles are the ones where the Invoices are not yet due and are in an 'Ongoing' state. By enabling this configuration, you can override a customer's price plan and make any changes and apply them at anypoint from the start of the current ongoing cycle.
